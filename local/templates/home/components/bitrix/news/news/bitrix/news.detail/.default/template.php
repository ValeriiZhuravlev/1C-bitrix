        ...
        <div class="row">
            <div class="col-lg-8" style="margin-top: -150px;">
                ...
                <div class="bg-white">
                        ...
                        <div class="col-md-6">
                            <ul class="property-specs-wrap mb-3 mb-lg-0  float-lg-right">
                                ...
                                <li>
                                    ...
                                    <span class="property-specs-number">
                                        <?= $arResult["DISPLAY_PROPERTIES"]["NUMB_FLOORS"]["VALUE"] ?>
                                    </span>
                                </li>
                                <li>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                            ...
                            <strong class="d-block">
                                <?= $arResult["DISPLAY_PROPERTIES"]["NUMB_BATHROOMS"]["VALUE"] ?>
                            </strong>
                        </div>
                        <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                            <span class="d-inline-block text-black mb-0 caption-text">
                            ...
                            <strong class="d-block">
                                <?= $arResult["DISPLAY_PROPERTIES"]["GARAGE"]["VALUE"] ?>
                            </strong>
                        </div>
                    </div>
                    ...
                    <div class="row mt-5">
                        <? if ($arResult["DISPLAY_PROPERTIES"]["ADD_MATERIAL"] ): ?>
                            <div class="col-12">
                                <h2 class="h4 text-black mb-3"><?= GetMessage("ADD MATERIAL") ?></h2>
                            </div>
                            <? foreach ($arResult["DISPLAY_PROPERTIES"]["ADD_MATERIAL"]["FILE_VALUE"] as $image): ?>
                ...
                <? if ($arResult["DISPLAY_PROPERTIES"]["ADD_MATERIAL"]):
                    ...
                    foreach ($arResult["DISPLAY_PROPERTIES"]["ADD_MATERIAL"]["FILE_VALUE"] as $addMaterial): ?>
                        <div>
                            <a href="<?= $addMaterial["SRC"] ?> " download>
                                <?= $addMaterial["ORIGINAL_NAME"] ?>
                            </a>
                        </div>
                    <? endforeach ?>
                <? endif ?>

                <? if ($arResult["DISPLAY_PROPERTIES"]["LINK"]):
                    foreach ($arResult["DISPLAY_PROPERTIES"]["LINK"]["VALUE"] as $link): ?>
                        <div>
                            <a href="<?= $link ?>"><?= $link ?></a>
                        </div>
                    <? endforeach ?>
